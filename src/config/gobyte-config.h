/* src/config/gobyte-config.h.  Generated from gobyte-config.h.in by configure.  */
/* src/config/gobyte-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/gobytecoin/gobyte/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GoByte Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GoByte Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gobytecore"
